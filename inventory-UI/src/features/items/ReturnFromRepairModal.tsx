...
const styles = {
  ...
  iconBox: {
    width: 40, height: 40, borderRadius: 10, background: 'rgba(22, 163, 74, 0.15)',
  ...
  form: { padding: 24 },
  alert: {
    padding: '12px 16px', background: 'var(--color-success-bg)', borderRadius: 8,
    border: '1px solid var(--color-border)', color: 'var(--color-success)',
