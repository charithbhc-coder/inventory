          ...
          <mj-section css-class="mobile-padding" padding="40px 40px 20px">
            <mj-column>
              ...
              <mj-text font-size="15px">
                Your account setup is complete, and you are now a verified member of the <strong>KTMG-Vault Enterprise Inventory System</strong>.
              </mj-text>
              <mj-text font-size="15px">
          ...
          <mj-section background-color="#f8fafc" padding="20px 40px">
            <mj-column>
              <mj-text font-size="11px" color="#94a3b8" align="center">
                © 2026 KTMG Systems. This is an automated success notification.
              </mj-text>
            </mj-column>
          </mj-section>
