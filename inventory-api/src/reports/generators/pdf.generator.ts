...
export class PdfGenerator {
  ...
  buildReportHtmlWrapper(title: string, tableHtml: string, generatedByContext?: string): string {
    return `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <style>
          ...
          h1 { color: #1677ff; border-bottom: 2px solid #f0f0f0; padding-bottom: 2px; margin-bottom: 10px; }
          .timestamp { color: #888; font-size: 12px; margin-bottom: 6px; }
          .meta-container { margin-bottom: 30px; border-bottom: 1px solid #f0f0f0; padding-bottom: 15px; }
      ...
      <body>
        <div class="meta-container">
          <div style="font-size: 16px; font-weight: bold; color: #111; margin-bottom: 4px;">Inventory system generated report</div>
          <h1>${title}</h1>
          <div class="timestamp">Generated on: ${formatInSystemTz()}</div>
          ${generatedByContext ? `<div class="timestamp">Generated by: ${generatedByContext}</div>` : ''}
        </div>
        ${tableHtml}
      </body>
      </html>
