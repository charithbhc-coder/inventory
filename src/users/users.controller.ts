...
export class UsersController {
  ...
  findAll(
    ...
    return this.usersService.findAll({ page, limit, search, role, isActive, companyId });
  }
  ...
  @ApiOperation({ summary: 'Update user profile/role (Super Admin only)' })
  update(
    @Param('id') id: string,
  ...
  @Patch(':id/status')
  @Roles(UserRole.SUPER_ADMIN)
  @ApiOperation({ summary: 'Deactivate / reactivate a user (Super Admin only)' })
  setStatus(
    @Param('id') id: string,
